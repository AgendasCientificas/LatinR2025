...
authors:
  ...
  - first_name: Florencia 
    ...
    country: ar
    affiliation: Centro de Neurociencias Cognitivas (CNC, UDESA - CONICET)
presenter: 1
keywords:
  - Agendas científicas
  - Desarrollo infantil
...
Todos los análisis se realizaron mediante el lenguaje R versión 4.4.2 \citep{R-base}, en Rstudio \citep{R-studio}. Los principales paquetes utilizados fueron dplyr \citep{R-dplyr}, ggplot2 \citep{R-ggplot2}, leaflet \citep{R-leaflet}, y geoAr \citep{R-geoAr}.
